...
LABEL maintainer="Philemy Julien-Aymar <julien-aymar.philemy@edu.esiee.fr>" \
    version="1.0"

# Commande de démarrage du serveur gunicorn
CMD ["gunicorn", "--bind", "0.0.0.0:5001", "app:app", "--log-level", "info", "--error-logfile", "-", "--access-logfile", "-"]